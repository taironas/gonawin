...
func init(){
	...
	// user
	h.HandleFunc("/j/users/?", handlers.Authorized(handlers.ErrorHandler(usersctrl.IndexJson)))
	h.HandleFunc("/j/users/show/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(usersctrl.ShowJson)))
	h.HandleFunc("/j/users/update/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(usersctrl.UpdateJson)))
	// team
	h.HandleFunc("/j/teams/?", handlers.Authorized(handlers.ErrorHandler(teamsctrl.IndexJson)))
	h.HandleFunc("/j/teams/new/?", handlers.Authorized(handlers.ErrorHandler(teamsctrl.NewJson)))
	h.HandleFunc("/j/teams/show/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(teamsctrl.ShowJson)))
	h.HandleFunc("/j/teams/update/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(teamsctrl.UpdateJson)))
	h.HandleFunc("/j/teams/destroy/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(teamsctrl.DestroyJson)))
	h.HandleFunc("/j/teams/invite/?", handlers.Authorized(handlers.ErrorHandler(teamsctrl.InviteJson)))
	h.HandleFunc("/j/teams/request/?", handlers.Authorized(handlers.ErrorHandler(teamsctrl.RequestJson)))
	// tournament - json
	h.HandleFunc("/j/tournaments/?", handlers.Authorized(handlers.ErrorHandler(tournamentsctrl.IndexJson)))
	h.HandleFunc("/j/tournaments/new/?", handlers.Authorized(handlers.ErrorHandler(tournamentsctrl.NewJson)))
	h.HandleFunc("/j/tournaments/show/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(tournamentsctrl.ShowJson)))
	h.HandleFunc("/j/tournaments/update/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(tournamentsctrl.UpdateJson)))
	h.HandleFunc("/j/tournaments/destroy/[0-9]+/?", handlers.Authorized(handlers.ErrorHandler(tournamentsctrl.DestroyJson)))
	// relationships - json
	h.HandleFunc("/j/teamrels/create/?", handlers.Authorized(handlers.ErrorHandler(teamrelsctrl.CreateJson)))
	h.HandleFunc("/j/teamrels/destroy/?", handlers.Authorized(handlers.ErrorHandler(teamrelsctrl.DestroyJson)))
	h.HandleFunc("/j/tournamentrels/create/?", handlers.Authorized(handlers.ErrorHandler(tournamentrelsctrl.CreateJson)))
	h.HandleFunc("/j/tournamentrels/destroy/?", handlers.Authorized(handlers.ErrorHandler(tournamentrelsctrl.DestroyJson)))
	h.HandleFunc("/j/tournamentteamrels/create/?", handlers.Authorized(handlers.ErrorHandler(tournamentteamrelsctrl.CreateJson)))
	h.HandleFunc("/j/tournamentteamrels/destroy/?", handlers.Authorized(handlers.ErrorHandler(tournamentteamrelsctrl.DestroyJson)))
	// invite -json
	h.HandleFunc("/j/invite/?", handlers.Authorized(handlers.ErrorHandler(invitectrl.InviteJson)))
