...
angular.module('purpleWingApp').controller('SessionController', function ($scope, $http, $cookieStore) {
    console.log('SessionController module');
    $scope.loggedIn = false;
    render();
    function render(){
	console.log('render SessionController');
	...
	var authUrl = window.location.href + '/auth/google/callback'
	$.ajax({
	    type: 'GET',
	    url: authUrl,
	    contentType: 'application/json',
